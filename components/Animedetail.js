...
const Animedetail = ({
  ...
  return (
    <div className="flex items-start justify-start md:gap-x-48 lg:gap-x-0 xl:gap-x-16 flex-col md:flex-row">
      <Table className="Table">
        ...
        <TableBody>
          <TableRow className="TableRow">
            <TableCell className="TableCell font-medium">Premiered:</TableCell>
        ...
        <TableBody>
          <TableRow className="TableRow">
            ...
            <TableCell className="TableCellText text-left ">{status}</TableCell>
          </TableRow>
        </TableBody>
        <TableBody>
          <TableRow className="TableRow">
            <TableCell className="TableCell font-medium">Duration:</TableCell>
            <TableCell className="TableCellText text-left ">{duration}</TableCell>
          </TableRow>
        </TableBody>
        <TableBody>
          <TableRow className="TableRow">
            <TableCell className="TableCell font-medium">Studios:</TableCell>
            <TableCell className="TableCellText text-left ">{studios}</TableCell>
          </TableRow>
        </TableBody>
      </Table>
      ...
      <Table className="Table">
        <TableBody>
          <TableRow className="TableRow">
            ...
            <TableCell className="TableCellText text-left ">{japanese}</TableCell>
          </TableRow>
        </TableBody>
        <TableBody>
          <TableRow className="TableRow">
        ...
        <TableBody>
          <TableRow className="TableRow">
            ...
            <TableCell className="TableCellText text-left ">{aired}</TableCell>
          </TableRow>
        </TableBody>
        <TableBody>
          <TableRow className="TableRow">
            <TableCell className="TableCell font-medium">Themes:</TableCell>
            <TableCell className="TableCellText text-left ">{themes}</TableCell>
          </TableRow>
        </TableBody>
        <TableBody>
          <TableRow className="TableRow">
            <TableCell className="TableCell font-medium">Genres:</TableCell>
            <TableCell className="TableCellText text-left ">{genres}</TableCell>
          </TableRow>
        </TableBody>
      </Table>
    </div>
